		...
		<div class="inside">
			<div class="left">
				...
				<div>
					...
					<div class="tab">
						<button class="tablinks" style="display: none;" onclick="openSeminar(event, '20202021')"><?php the_field('seminar_title', 2618); ?> <?php the_field('seminar_year', 2618); ?></button>
					</div>
					<div class="tab">
						<span class="arrowEffectUp" id="tabMinus1"></span>
						<span class="arrowEffectDown" id="tabMinus2"></span>
						<button class="tablinks active" onclick="openSeminar(event, '20192020')"><?php the_field('seminar_title', 660); ?> <?php the_field('seminar_year', 660); ?></button>
					</div>
					<div class="tab">
			...
			<div class="center">
				...
				<!-- Tab content -->
				<div id="20202021" class="tabcontent">
					<div class="post-list">
		...
		<div style="display: grid; height: 100%;">
			<div class="inside">
				<div class="left" style="display: flex; flex-direction: column;">
					...
					<img src="/wp-content/uploads/2020/12/Unimi_dip_filo.png" alt="" style="width: 352px;">
					<img src="/wp-content/uploads/2020/12/ERC_EU.png" alt="" style="width: 145px;">
				</div>
				<div class="right">
					<div class="contact-form" style="width: 100%;">
						<?php echo do_shortcode('[mc4wp_form id="2570"]'); ?>
					</div>
				</div>
			</div>
			<!-- <div class="inside logos" style="border-top: 0;">
